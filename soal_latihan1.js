       // Random soalnya
        let random = latihan1.sort((a, b) => {return 0.5 - Math.random()})
            ...
            tampilkanSoal.forEach((currentQuestion, questionNumber) => {
                ...
                for(letter in currentQuestion.jawaban) {
                    jawaban.push(
                        `
                           <label>
                                <input type="text" name="soal${questionNumber}" value="${letter}"> 
        ...
        function results() {
            ...
            tampilkanSoal.forEach((currentQuestion, questionNumber) => {
                ...
                if(userAnswer === currentQuestion.jawaban) {
                    numCorrect++
                } else {
                    numWrong++
                }
            ...
            location.replace('./hasil_latihan1.html')
        }
