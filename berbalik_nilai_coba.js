$(document).ready(function(){
	...
	function soalbagian1() {
		let url = "berbalik_nilai_coba.json";
		$.getJSON(url, function(data){
			let random = Math.floor(Math.random()*data.berbalik_nilai1.length);
			$("#randomsoal1").html(data.berbalik_nilai1[random].soal1);
			
			$("#inputjawaban1").html(data.berbalik_nilai1[random].jawab1);
		})
	}
	...
	function soalbagian2() {
		let url = "berbalik_nilai_coba.json";
		$.getJSON(url, function(data){
			let random = Math.floor(Math.random()*data.berbalik_nilai2.length);
			$("#randomsoal2").html(data.berbalik_nilai2[random].soal2);
			
			$("#inputjawaban2").html(data.berbalik_nilai2[random].jawab2);
		})
	}
	...
	function soalbagian3() {
		let url = "berbalik_nilai_coba.json";
		$.getJSON(url, function(data){
			let random = Math.floor(Math.random()*data.berbalik_nilai3.length);
			$("#randomsoal3").html(data.berbalik_nilai3[random].soal3);
			
			$("#inputjawaban3").html(data.berbalik_nilai3[random].jawab3);
		})
	}
	...
	function soalbagian4() {
		let url = "berbalik_nilai_coba.json";
		$.getJSON(url, function(data){
			let random = Math.floor(Math.random()*data.berbalik_nilai4.length);
			$("#randomsoal4").html(data.berbalik_nilai4[random].soal4);
			
			$("#inputjawaban4").html(data.berbalik_nilai4[random].jawab4);
		})
	}
	...
	function soalbagian5() {
		let url = "berbalik_nilai_coba.json";
		$.getJSON(url, function(data){
			let random = Math.floor(Math.random()*data.berbalik_nilai5.length);
			$("#randomsoal5").html(data.berbalik_nilai5[random].soal5);
			
			$("#inputjawaban5").html(data.berbalik_nilai5[random].jawab5);
		})
	}
